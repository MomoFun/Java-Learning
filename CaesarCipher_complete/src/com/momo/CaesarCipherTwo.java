...
public class CaesarCipherTwo {
	...
	public CaesarCipherTwo(int key){
		this.key = key;
	...
	public static void main(String[] args){
		int key1 = 21;
		int key2 = 8;
		CaesarCipherTwo cc1 = new CaesarCipherTwo(key1);
		CaesarCipherTwo cc2 = new CaesarCipherTwo(key2);
...
//		int dKey2 = 24;
		...
		CaesarCipherTwo dcc1 = new CaesarCipherTwo(26-dKey1);	
		CaesarCipherTwo dcc2 = new CaesarCipherTwo(26-dKey2);	
